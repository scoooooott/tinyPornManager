...
public class OmdbMetadataProviderTest {
	...
	private List<MediaSearchResult> resultList;
	private List<MediaEpisode> episodeList;
	private MediaSearchOptions options = new MediaSearchOptions(MediaType.MOVIE);

	private String apiKey = "";
	OmdbMetadataProvider mp = new OmdbMetadataProvider("d244ff0b");
	...
	public void testProviderInfo() {
		...
		MediaProviderInfo providerInfo = new OmdbMetadataProvider("d244ff0b").getProviderInfo();
	...
	public void testScrapeById() {
		...
		try {
			...
			// Matrix
			scrapeOptions.setId(mp.getProviderInfo().getId(), "tt0133093");
