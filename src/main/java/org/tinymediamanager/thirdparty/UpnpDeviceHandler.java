...
public class UpnpDeviceHandler extends DefaultHandler {
   ...
   */
  public UpnpDeviceHandler(final UpnpDevice device) {
    this.device = device;
  }
   ...
   * 
   * Caches the element as {@link #currentElement}, and keeps track of some basic state information.
   * 
   * @param uri
   ...
   * 
   * <p>
   * By default, do nothing. Application writers may override this method in a subclass to take specific actions at the end of each element (such as
   ...
   * 
   * It is used to read the values of the relevant fields of the device being configured.
   * 
   * @param ch
   *          The characters.
   * @param start
