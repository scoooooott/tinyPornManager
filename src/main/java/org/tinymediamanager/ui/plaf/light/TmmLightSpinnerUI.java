...
public class TmmLightSpinnerUI extends BaseSpinnerUI {
  /**
  ...
  /**
   * Returns a new instance of TmmLightSpinnerUI. SpinnerListUI delegates are allocated one per JSpinner.
   *
   * @param c
