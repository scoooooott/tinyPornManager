...
public class TmmLightLabelUI extends BaseLabelUI {

  private static TmmLightLabelUI labelUI = null;

  public static ComponentUI createUI(JComponent c) {
    if (labelUI == null) {
      labelUI = new TmmLightLabelUI();
    }
    return labelUI;
  }
  ...
  protected String layoutCL(JLabel label, FontMetrics fontMetrics, String text, Icon icon, Rectangle viewR, Rectangle iconR, Rectangle textR) {
    String stringFromSwingUtilities = SwingUtilities.layoutCompoundLabel((JComponent) label, fontMetrics, text, icon, label.getVerticalAlignment(),
