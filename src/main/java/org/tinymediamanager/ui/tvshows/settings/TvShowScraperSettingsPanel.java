    ...
    }
    {
      ...
      tableScraper = new JTable() {
        ...
        public java.awt.Component prepareRenderer(TableCellRenderer renderer, int row, int col) {
          ...
          if (!Globals.isDonator() && value.startsWith("Kodi")) { // $NON-NLS-1$ // FIXME: use scraper.isEnabled() somehow?
