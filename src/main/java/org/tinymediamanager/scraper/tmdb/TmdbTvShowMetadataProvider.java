...
class TmdbTvShowMetadataProvider {
   ...
   * @throws UnsupportedMediaTypeException unsupported media type
   */
   ...
   *
   * @param query      the query options
   * @param original   the original tv show list
   * @param resultList the list that tv shows will be added.
   * @throws IOException
   */
