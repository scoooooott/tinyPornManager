...
class TraktEpisodeMetadataProvider {
  private static final Logger LOGGER = LoggerFactory.getLogger(TraktEpisodeMetadataProvider.class);

  final TraktV2               api;

  public TraktEpisodeMetadataProvider(TraktV2 api) {
    this.api = api;
  }
