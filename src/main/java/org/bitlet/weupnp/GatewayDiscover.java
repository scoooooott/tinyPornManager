...
public class GatewayDiscover {
   ...
   * <p/>
   * The host may be connected to different networks via different network interfaces. Assumes that each network interface has a different InetAddress
   * and returns a map associating every GatewayDevice (responding to a broadcast discovery message) with the InetAddress it is connected to.
   * 
   ...
   */
  public Map<InetAddress, GatewayDevice> discover()
