...
public class BaseTabbedPaneUI extends TabbedPaneUI implements SwingConstants {
  ...
  /**
   * Paints the tabs in the tab area. Invoked by paint(). The graphics parameter must be a valid <code>Graphics</code> object. Tab placement may be
   * either: <code>JTabbedPane.TOP</code>, <code>JTabbedPane.BOTTOM</code>, <code>JTabbedPane.LEFT</code>, or <code>JTabbedPane.RIGHT</code>. The
   ...
   * <code>Rectangle</code> instance. The handling of invalid parameters is unspecified.
   *
   * @param tabIndex
