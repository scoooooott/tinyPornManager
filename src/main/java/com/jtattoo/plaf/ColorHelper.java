...
public class ColorHelper {
  ...
  /**
   * Avoid creation of this class. This class only contains static helper methods, so creation of an object is not necessary.
   */
  private ColorHelper() {
  }
   ...
   *          the ending color
   * @param steps
   *          the number of steps between c1 and c2 (the size of the created array)
   * 
   ...
   *          the color
   * @param p
   *          the factor of the brightness in percent from 0 to 100
   ...
   *          the color
   * @param p
   *          the factor to shade the color c in percent from 0 to 100
   * 
   ...
   * 
   * @param c
   *          the color you want to calculate the gray value
   * 
   ...
   * 
   * @param ca
   *          the color array you want to calculate the gray value
   * 
   * @return the gray value
   */
