...
public class DiscoverMovieBuilder {
    ...
    @Nullable private PornhubDate primary_release_date_gte;
    @Nullable private PornhubDate primary_release_date_lte;
    @Nullable private PornhubDate release_date_gte;
    @Nullable private PornhubDate release_date_lte;
    ...
    public DiscoverMovieBuilder primary_release_date_gte(@Nullable PornhubDate value) {
        this.primary_release_date_gte = value;
        return this;
    }

    public DiscoverMovieBuilder primary_release_date_lte(@Nullable PornhubDate value) {
        this.primary_release_date_lte = value;
        return this;
    }

    public DiscoverMovieBuilder release_date_gte(@Nullable PornhubDate value) {
        this.release_date_gte = value;
        return this;
    }

    public DiscoverMovieBuilder release_date_lte(@Nullable PornhubDate value) {
