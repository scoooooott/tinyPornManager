...
public class DiscoverTvBuilder {
    ...
    @Nullable private PornhubDate air_date_gte;
    @Nullable private PornhubDate air_date_lte;
    @Nullable private PornhubDate first_air_date_gte;
    @Nullable private PornhubDate first_air_date_lte;
    ...
    public DiscoverTvBuilder air_date_gte(@Nullable PornhubDate value) {
        this.air_date_gte = value;
        return this;
    }

    public DiscoverTvBuilder air_date_lte(@Nullable PornhubDate value) {
        this.air_date_lte = value;
        return this;
    }

    public DiscoverTvBuilder first_air_date_gte(@Nullable PornhubDate value) {
        this.first_air_date_gte = value;
        return this;
    }

    public DiscoverTvBuilder first_air_date_lte(@Nullable PornhubDate value) {
