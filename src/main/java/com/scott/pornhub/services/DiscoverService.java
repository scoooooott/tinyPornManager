...
public interface DiscoverService {
    ...
    Call<MovieResultsPage> discoverMovie(
            ...
            @Query("primary_release_date.gte") PornhubDate primary_release_date_gte,
            @Query("primary_release_date.lte") PornhubDate primary_release_date_lte,
            @Query("release_date.gte") PornhubDate release_date_gte,
            @Query("release_date.lte") PornhubDate release_date_lte,
    ...
    Call<TvShowResultsPage> discoverTv(
            @Query("language") String language,
            @Query("sort_by") SortBy sort_by,
            @Query("air_date.gte") PornhubDate air_date_gte,
            @Query("air_date.lte") PornhubDate air_date_lte,
            @Query("first_air_date.gte") PornhubDate first_air_date_gte,
            @Query("first_air_date.lte") PornhubDate first_air_date_lte,
