...
public class ApiException extends Exception {
   ...
   * @param response
   *          A response message associated with the exception
   */
   ...
   *          A response message associated with the exception
   * @param responseCode
   *          A response code, such as the HTTP status from a web request
   * @param url
   *          The URL that cause the exception or is associated with it
   */
   ...
   *          The URL that cause the exception or is associated with it
   * @param cause
   *          The underlying exception that was the cause of this API Exception
   */
  ...
  public ApiException(final ApiExceptionType exceptionType, final String response, final int responseCode, final String url, final Throwable cause) {
    super("ExceptionType=" + exceptionType + ", ResponseCode=" + responseCode + ", URL=" + url + ", cause=" + cause.getMessage(), cause);
    this.exceptionType = exceptionType;
    this.response = response;
    this.responseCode = responseCode;
    this.url = url;
