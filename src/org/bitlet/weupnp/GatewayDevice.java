...
public class GatewayDevice {
   ...
   * <p/>
   * Connects to the device's {@link #location} and parses the response using a {@link GatewayDeviceHandler} to populate the fields of this class
   * 
   * @throws SAXException
  ...
  /**
   * Issues UPnP commands to a GatewayDevice that can be reached at the specified <tt>url</tt>
   * <p/>
   * The command is identified by a <tt>service</tt> and an <tt>action</tt> and can receive arguments
   * 
   * @param url
   ...
   */
  public static Map<String, String> simpleUPnPcommand(String url, String service, String action, Map<String, String> args) throws IOException,
      SAXException {
    String soapAction = "\"" + service + "#" + action + "\"";
    StringBuilder soapBody = new StringBuilder();

    soapBody.append("<?xml version=\"1.0\"?>\r\n" + "<SOAP-ENV:Envelope " + "xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\" "
        + "SOAP-ENV:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">" + "<SOAP-ENV:Body>" + "<m:" + action + " xmlns:m=\"" + service
        + "\">");
   ...
   * @throws IOException
   * @throws SAXException
   * @see #simpleUPnPcommand(java.lang.String, java.lang.String, java.lang.String, java.util.Map)
   */
   ...
   */
  public boolean addPortMapping(int externalPort, int internalPort, String internalClient, String protocol, String description) throws IOException,
      SAXException {
   ...
   * <p/>
   * Retrieves the <tt>PortMappingEntry</tt> associated with <tt>externalPort</tt> and <tt>protocol</tt>, if present.
   * 
   * @param externalPort
   *          the external port
   * @param protocol
   ...
   *          the entry containing the details, in any is present, <i>null</i> otherwise. <i>(used as return value)</i>
   * @return true if a valid mapping is found
   * @throws IOException
   * @throws SAXException
   * @todo consider refactoring this method to make it consistent with Java practices (return the port mapping)
   * @see #simpleUPnPcommand(java.lang.String, java.lang.String, java.lang.String, java.util.Map)
   * @see PortMappingEntry
   */
  public boolean getSpecificPortMappingEntry(int externalPort, String protocol, final PortMappingEntry portMappingEntry) throws IOException,
      SAXException {
