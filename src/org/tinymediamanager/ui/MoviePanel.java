...
public class MoviePanel extends JPanel {
  ...
  public MoviePanel() {
    ...
    panelMovieList.setLayout(new FormLayout(new ColumnSpec[] { FormFactory.RELATED_GAP_COLSPEC, FormFactory.DEFAULT_COLSPEC, ColumnSpec.decode("max(200px;default):grow"), },
