...
public class SettingsPanel extends JPanel {
  ...
  public SettingsPanel() {
    ...
    panelMovieSettings.setLayout(new FormLayout(new ColumnSpec[] { FormFactory.RELATED_GAP_COLSPEC, ColumnSpec.decode("max(121dlu;default)"), FormFactory.RELATED_GAP_COLSPEC,
        ColumnSpec.decode("default:grow"), }, new RowSpec[] { FormFactory.RELATED_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC, FormFactory.RELATED_GAP_ROWSPEC,
    ...
    panelMovieImages.setLayout(new FormLayout(new ColumnSpec[] { FormFactory.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormFactory.RELATED_GAP_COLSPEC,
        FormFactory.DEFAULT_COLSPEC, }, new RowSpec[] { FormFactory.RELATED_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC, FormFactory.RELATED_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC,
        FormFactory.RELATED_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC, }));
...

    {
      ...
      // }
      // });
      // TMDB Image-Poster-Sizes
      // for (String size : TmdbMetadataProvider.supportedPosterSizes) {
      // cbImageTmdbPosterSize.addItem(size);
      // if (size.equals(settings.getImageTmdbPosterSize())) {
      // int index = cbImageTmdbPosterSize.getItemCount();
      // cbImageTmdbPosterSize.setSelectedIndex(index - 1);
      // }
      // }
      // cbImageTmdbPosterSize.addItemListener(new ItemListener() {
      // public void itemStateChanged(ItemEvent e) {
      // if (e.getStateChange() == ItemEvent.SELECTED) {
      // String size = (String) e.getItem();
      // settings.setImageTmdbPosterSize(size);
      // }
      // }
      // });
      // // TMDB Image-Fanart-Sizes
      // for (String size : TmdbMetadataProvider.supportedFanartSizes) {
      // cbImageTmdbFanartSize.addItem(size);
      // if (size.equals(settings.getImageTmdbFanartSize())) {
      // int index = cbImageTmdbFanartSize.getItemCount();
      // cbImageTmdbFanartSize.setSelectedIndex(index - 1);
      // }
      // }
      // cbImageTmdbFanartSize.addItemListener(new ItemListener() {
      // public void itemStateChanged(ItemEvent e) {
      // if (e.getStateChange() == ItemEvent.SELECTED) {
      // String size = (String) e.getItem();
      // settings.setImageTmdbFanartSize(size);
      // }
      // }
      // });
    }
