...
public class ImageChooser extends JDialog {
   ...
   * Create the dialog.
   */
  public ImageChooser(String imdbId, int tmdbId, String imageUrl, ImageType type) {
    setModal(true);
    ...
    }
    {
      ...
      buttonPane.setLayout(new FormLayout(new ColumnSpec[] { FormFactory.RELATED_GAP_COLSPEC, ColumnSpec.decode("100px"),
          FormFactory.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormFactory.RELATED_GAP_COLSPEC, ColumnSpec.decode("47px"),
          FormFactory.LABEL_COMPONENT_GAP_COLSPEC, ColumnSpec.decode("65px"), }, new RowSpec[] { FormFactory.LINE_GAP_ROWSPEC,
          RowSpec.decode("23px"), }));
      {
  ...
  private class DownloadTask extends SwingWorker<Void, Void> {
    ...
    public Void doInBackground() {
      ...
      try {
        MediaMetadata metadata = tmdb.getArtwork(tmdbId, ArtworkSize.SMALL);
