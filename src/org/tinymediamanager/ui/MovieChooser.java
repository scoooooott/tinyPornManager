...
public class MovieChooser extends JDialog implements ActionListener {
  ...
  public MovieChooser(Movie movie) {
    ...
    }
    {
      ...
      }
      {
        ...
        panelSearchDetail
            .setLayout(new FormLayout(new ColumnSpec[] { ColumnSpec.decode("left:max(150px;default)"), FormFactory.RELATED_GAP_COLSPEC,
                ColumnSpec.decode("max(300px;default):grow"), }, new RowSpec[] { RowSpec.decode("30px"), RowSpec.decode("200px"),
                FormFactory.RELATED_GAP_ROWSPEC, RowSpec.decode("fill:default:grow"), FormFactory.RELATED_GAP_ROWSPEC,
        ...
        }
        {
          ...
          panelSearchDetail.add(tpMovieDescription, "1, 6, 3, 1, fill, fill");
        }
      }
    }
  ...
  class ScrapeTask extends SwingWorker<Void, Void> {
